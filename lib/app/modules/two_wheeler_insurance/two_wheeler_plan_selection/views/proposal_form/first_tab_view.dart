...
class FirstTabAsOwnerView extends GetView {
            ...
            child: Column(
              ...
              children: [
                ...
                BorderTextField(
                  ...
                  titleText: 'name'.tr + "*",
                  controller:
                      twoWheelerPlanSelectionController.NameController.value,
                  onValidate: (val) {
                ...
                BorderTextField(
                  ...
                  controller:
                      twoWheelerPlanSelectionController.EmailController.value,
                ...
                BorderTextField(
                  ...
                  maxLength: 10,
                  controller:
                      twoWheelerPlanSelectionController.PancardController.value,
                  onValidate: (val) {
                    if (val.toString().isEmpty) {
