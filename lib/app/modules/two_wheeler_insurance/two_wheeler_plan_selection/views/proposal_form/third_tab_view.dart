...
class ThirdTabAsVechicleView extends GetView {
          ...
          child: Column(
            ...
            children: [
              ...
              BorderTextField(
                ...
                controller:
                    twoWheelerPlanSelectionController.regNoController.value,
                onValidate: (val) {
              ...
              BorderTextField(
                ...
                maxLength: 17,
                controller:
                    twoWheelerPlanSelectionController.EnginenoController.value,
                onValidate: (val) {
                  if (val.toString().isEmpty) {
              ...
              BorderTextField(
                ...
                maxLength: 17,
                controller:
                    twoWheelerPlanSelectionController.ChassisController.value,
                onValidate: (val) {
                  if (val.toString().isEmpty) {
              ...
              Obx(
                () => BorderTextField(
                  key:Key('vehile_register_date_key'),
                  readOnly: true,
                  onTap: () async {
