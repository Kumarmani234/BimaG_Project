...
class PanCardPreview extends GetView<MemberDocumentController> {
  @override
            ...
            Obx(
              () => ListView.separated(
                ...
                itemBuilder: (ctx, index) => DocumentView(
                  imageUrl: memberDocumentController.DocumentList[2].img_url
                      .toString(),
                  documentType: memberDocumentController
                      .DocumentList[2].documentType
                      .toString(),
                  documentNo: memberDocumentController
                      .DocumentList[2].documentNo
                      .toString(),
                ),
